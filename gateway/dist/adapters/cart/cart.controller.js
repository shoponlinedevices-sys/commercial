...
let CartController = class CartController {
    ...
    async addToCart(body) {
        try {
            ...
            const cartLinesWithName = cartLines.map(line => (Object.assign(Object.assign({}, line), { name: product.name, totalPrice: (line.unitPrice * line.quantity).toString() })));

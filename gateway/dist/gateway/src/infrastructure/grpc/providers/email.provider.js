...
let EmailProvider = class EmailProvider {
    ...
    async sendEmail(data) {
        return (0, rxjs_1.firstValueFrom)(this.grpcEmailService.sendEmail(data));
    }
    async sendOrderConfirmationEmail(data) {
        return (0, rxjs_1.firstValueFrom)(this.grpcEmailService.sendOrderConfirmationEmail(data));
    }
    async sendPasswordResetEmail(data) {
        return (0, rxjs_1.firstValueFrom)(this.grpcEmailService.sendPasswordResetEmail(data));
    }
};
